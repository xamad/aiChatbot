...
<div class="card"><h3>Server Agent AI</h3>
<label>URL Agent</label><input type="text" id="c_agent_url" placeholder="https://skyguardai.xamad.net">
<p style="color:#556677;font-size:.7em">Telemetria completa per il server multi-agent swarm.</p>
...
if(d.agent_server_url)document.getElementById('c_agent_url').value=d.agent_server_url;
...
agent_server_url:document.getElementById('c_agent_url').value,
...
esp_err_t SkyGuardWebUI::HandleGetConfig(httpd_req_t* req) {
    ...
    std::string agent_url = s.GetString("agent_server_url", "https://skyguardai.xamad.net");
    ...
    cJSON_AddStringToObject(root, "agent_server_url", agent_url.c_str());
...
esp_err_t SkyGuardWebUI::HandlePostConfig(httpd_req_t* req) {
    ...
    saveKey("agent_server_url", "agent_server_url");

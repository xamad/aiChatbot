...
public:
    ...
    // Floating star avatar — always on top, draggable, tap to talk
    using FloatingStarTapCallback = void(*)(void* ctx);
    void SetFloatingStarCallback(FloatingStarTapCallback cb, void* ctx) {
        star_tap_cb_ = cb; star_tap_ctx_ = ctx;
    }
    void SetFloatingStarVisible(bool visible);
...
private:
    ...
    static constexpr int WIND_COMPASS_SIZE = 76;
...
private:
    ...
    lv_obj_t* floating_star_ = nullptr;
    uint8_t* floating_star_buf_ = nullptr;
    lv_image_dsc_t floating_star_dsc_ = {};
    FloatingStarTapCallback star_tap_cb_ = nullptr;
    void* star_tap_ctx_ = nullptr;
    bool star_dragging_ = false;
    void CreateFloatingStar();

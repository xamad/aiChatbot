...
DRAFT - NON APPLICATO - Da valutare e testare
...
Architettura:
1. ESP32-S3 satellite con Meshtastic → espone API via MQTT o HTTP
2. Questo plugin sul server si connette al satellite
3. Il chatbot vocale chiama le funzioni di questo plugin
...
MQTT_TOPIC_ROOT = os.environ.get("MQTT_TOPIC", "meshtastic")
